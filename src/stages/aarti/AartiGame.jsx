          ...
          >
            <div
              ...
              style={{
                maxWidth: '520px',
                width: '100%',
                background: 'linear-gradient(145deg, rgba(38, 7, 13, 0.98), rgba(20, 2, 5, 0.98))',
                border: '2px solid var(--gold-400)',
                borderRadius: '24px',
                padding: '28px 32px',
                textAlign: 'center',
                boxShadow: '0 12px 50px rgba(0, 0, 0, 0.8), 0 0 40px rgba(245, 158, 11, 0.35)',
              }}
            >
              {/* Ear Guidance Icon */}
              <div
              ...
              >
                <Headphones size={32} color="var(--gold-400)" />
              </div>
              ...
              >
                📱 <strong>Keep your device close to your ear...</strong>
                <br />
                <span style={{ fontSize: '0.78rem', color: 'rgba(255, 255, 255, 0.75)', fontWeight: 400 }}>
                  Little Bal Ganesha will speak a cute, personalized secret blessing into your ear!
                </span>
              </p>
